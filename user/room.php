...
$link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] 
				=== 'on' ? "https" : "http") . "://" . 
		$_SERVER['SERVER_NAME'] . $_SERVER['PHP_SELF'] ."?id=".$id.""; 


?> 

	<!-- $_SERVER['PHP_SELF'].'?id='.$id=$_REQUEST['id']; -->
		<form id="myForm" action="" method="post">
 		<input type="text" name="links" id="links" value="<?php echo $link;?>" placeholder="">

		<input type="text" name="name" size="20" id="name" placeholder="email">
		
		<button style="margin-top: 4px;margin-left:80%;" type="button" class="btn btn-warning btn-sm" value="" id="send_invites">send</button>
