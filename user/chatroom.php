		...
		$(document).on('click', '#confirm_leave', function(){
			...
			$('.modal-backdrop').remove();
				$.ajax({
					...
					success: function(){
						window.location.href='index.php?id=<?php echo $_GET['id'] ?>';
					}
				});
...
// };
var localvideosContainer = document.getElementById('local_consultingRoom');
var remotevideosContainer = document.getElementById('remote_consultingRoom');
connection.onstream = function(event) {
